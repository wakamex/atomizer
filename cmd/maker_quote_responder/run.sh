...
RFQ_ASSET_ADDRESSES_CSV_DEFAULT="0xb67bfa7b488df4f2efa874f4e59242e9130ae61f"
...
RFQ_ASSET_ADDRESSES_CSV="${RFQ_ASSET_ADDRESSES_CSV:-$RFQ_ASSET_ADDRESSES_CSV_DEFAULT}"
...
./"$EXECUTABLE_NAME" \
    ...
    --rfq_asset_addresses_csv="$RFQ_ASSET_ADDRESSES_CSV" \
